...
var titulo = document.createTextNode("4.2.2");
...
if (valores[0] != valores[2]) {
	var resultado = document.createTextNode('El valor 0 del array "valores" es distinto que el valor 2 del mismo array: '+true);
}else{
	var resultado = document.createTextNode('El valor 0 del array "valores" es distinto que el valor 2 del mismo array: '+false);
}
